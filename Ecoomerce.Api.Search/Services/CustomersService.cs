...
namespace Ecommerce.Api.Search.Services
{
  public class CustomersService : ICustomersService
  {
    ...
    // dynamic Customer pour utuliser toutes les information renovyer / on peut aussi utuliser un objet concret (ajout une nouvelle class Customer dans le models).
